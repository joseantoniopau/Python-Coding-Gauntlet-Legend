...
| 11 | Timed Practical Mode disables AI and hints | ✅ | `test_11_interview_mode_disables_assistance` + all of `test_interview_isolation.py` (14 tests) |
...
| 16 | timed practical profile works | ✅ | `test_16_practical_interview_profile_works` — including rising difficulty |
...
Timed practical isolation is the criterion most likely to rot silently, so it has the
